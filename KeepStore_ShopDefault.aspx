<%@ Page Title="Shop Default" Language="VB" MasterPageFile="~/Page.master" AutoEventWireup="false" CodeFile="articoli.aspx.vb" Inherits="Articoli" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <div class="tf-shop-control-right d-flex align-items-center flex-wrap gap-10 ms-auto">
                            ...
                            <div class="d-flex align-items-center gap-8">
                                ...
                                <asp:DropDownList ID="Drop_Ordinamento" runat="server" AutoPostBack="True" CssClass="form-select form-select-sm">
                                    ...
                                    <asp:ListItem Value="P_offerta">Offerte</asp:ListItem>
