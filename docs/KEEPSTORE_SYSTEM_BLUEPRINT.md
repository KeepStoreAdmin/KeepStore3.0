...
Stato Git corrente al 2026-09-04: `frontend-rebuild` / `origin/frontend-rebuild` `c088988080e54371a60c27c1f5979adf957358f1`; `main` / `origin/main` a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. Il runtime promo route hotfix e stato integrato fast-forward only, senza merge commit, con parent diretto `e8dd8abf35afabd783c28090bca2df58ae7d7d7b`. Working tree atteso: soltanto asset immagini locali non tracciati e preservati. Le directory `Public/assets/images/articoli/`, `Public/assets/images/marche/` e `Public/assets/images/settori/` restano escluse dai commit; `Public/assets/images/vettori/` puo contenere altri loghi locali non tracciati, da non aggiungere in blocco e autorizzabili solo nominativamente nel manifest di un task. Nessun blocker corrente. Gli SHA STOREAVAIL, catalog parity, typography, product-image e hotfix precedenti restano riferimenti storici corretti, non descrizioni della stable corrente.
