...
| 2026-06-20 | CART-RECENTLY-VIEWED-1A | nuova PR | `c0e8cbeaf697805426f993ce3fd67028fc391bb6` | `carrello.aspx`, `carrello.aspx.vb`, `cart-ui.css`, documentazione | Blocco `Visti di recente` ONSUS-style in carrello e checkout, dati reali `ks_recent*`, max 8, esclusi articoli gia in carrello, CTA `Vedi prodotto` | Aggiunge una superficie commerciale utile senza alterare checkout core o calcoli | PR aperta da creare; smoke manuale utente richiesto; nessun cambio a ordine/gateway/email, prezzi/IVA/totali/righe, DB/schema/SP, auth/sessioni/cookie; PR #191/coupon sospesa/non toccata |
