...
Esempio vincolante: `articoli.aspx` ha micro-task chiusi su card prodotto, selezione multipla, quantita gia nel carrello, delta quantita, visual mobile, CTA `Acquista`, stato/paging deterministico e toolbar con quattro viste. Search/suggest, zero-results, sidebar/facet e filtri applicati mantengono i perimetri specifici gia documentati. Questo non rende la pagina catalogo completa ne "allineata ONSUS" in senso pieno: immagini 404 e gap P1/P2 dell'audit restano aperti.

Nota anti-false-closure: `articoli.aspx` non e una pagina dichiarata completa. `CATALOG-ONSUS-PARITY-AUDIT-1` e completato, ma i micro-task chiusi non equivalgono alla parita ONSUS completa. Immagini prodotto, sidebar/facet residui, load-more Marche, tassonomie, active filters legacy, Price/Deals/Condition, performance, componenti commerciali e responsive complessivo richiedono task successivi.

Stato Git stabile corrente dopo `CATALOG-ONSUS-PARITY-1B-TOOLBAR-CONTROLS`: `frontend-rebuild` / `origin/frontend-rebuild` a `9903687f89f99073d29cc0598746e17511f7e546`; `main` / `origin/main` a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. Gli SHA typography `d0f5f500...`, `efae083...` e `df98e70...` restano riferimenti storici, non stable corrente.
...
- Immagini prodotto 404 restano APERTE / P0. Prossimo runtime `CATALOG-ONSUS-PARITY-1C-IMAGE-PATH-404`: auditare path DB, file fisico, mapping `/Public/assets/images/articoli/`, deploy, `ThemeManager.ProductImageUrl` e placeholder appropriato. Le directory asset non tracciate non provano da sole la causa e non vanno committate automaticamente.
...
- `GLOBAL-TYPOGRAPHY-ONSUS-1C` e NON NECESSARIO / NON CREATO dopo esito A di `1B`; il blocco typography storefront e CHIUSO. La chiusura non dichiara complete HOME, catalogo, PDP, header, footer o l'area ecommerce. Il prossimo runtime ufficiale e `CATALOG-ONSUS-PARITY-AUDIT-1`, mentre side cart resta successivo e separato. Il vecchio `ARTICOLO-CART-QTY-IN-PDP-AUDIT-1` non e piu successivo: audit e runtime quantita PDP sono assorbiti dal cart-state storefront globale.
...
- `GLOBAL-TYPOGRAPHY-ONSUS-AUDIT-1`, `GLOBAL-TYPOGRAPHY-ONSUS-1A` e `GLOBAL-TYPOGRAPHY-ONSUS-1B`: CHIUSI / A. `GLOBAL-TYPOGRAPHY-ONSUS-1C`: NON NECESSARIO / NON CREATO. Il blocco typography storefront resta chiuso; l'audit catalog parity e `1A/1B` sono ora chiusi, senza dichiarare `articoli.aspx` completa.
- `CATALOG-ONSUS-PARITY-1C-IMAGE-PATH-404`: prossimo runtime ufficiale per il P0 immagini; i gap P1/P2 catalogo restano backlog successivo. `SIDE-CART-OFFCANVAS-ONSUS-AUDIT-1` resta separato e successivo alla parity catalogo.
