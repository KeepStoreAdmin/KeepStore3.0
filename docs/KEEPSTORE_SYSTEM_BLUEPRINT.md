...
- Debiti non chiusi: `CART-DEADLOCK-RETRY-1A`, `CART-IDEMPOTENCY-PERSISTENCE-AUDIT-1A`, `CART-MOBILE-RESPONSIVE-UX-1A`, target rimozione `44x44`, `HOME-TTFB-PERFORMANCE-1A`, `MYSQL-CONNECTOR-DEPENDENCY-AUDIT-1A` e audit monetari `DOUBLE`. `CART-BATCH-ATOMICITY-1A` e chiuso. Coupon/Groupon non e certificato: `COUPON-CART-LIFECYCLE-1A` resta differito e inattivo finche Germano non lo richiede; nessun percorso GET legacy va documentato come operativo.
