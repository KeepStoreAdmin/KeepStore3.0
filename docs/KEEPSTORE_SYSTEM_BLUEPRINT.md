...
- `GLOBAL-TYPOGRAPHY-ONSUS-1C` e NON NECESSARIO / NON CREATO dopo esito A di `1B`; il blocco typography storefront e CHIUSO. La chiusura non dichiara complete HOME, catalogo, PDP, header, footer o l'area ecommerce. Catalog audit e runtime `1A/1B/1C` sono poi stati eseguiti; `STOREFRONT-AVAILABILITY-PRESENTATION-1A` e integrato, `CATALOG-ASYNC-CART-1A` e il prossimo task, mentre side cart resta successivo e separato. Il vecchio `ARTICOLO-CART-QTY-IN-PDP-AUDIT-1` non e piu successivo: audit e runtime quantita PDP sono assorbiti dal cart-state storefront globale.
...
- `CATALOG-ONSUS-PARITY-1C-IMAGE-PATH-404`: CHIUSO / A; anche pager/posizione recent, quattro viste mobile, compact grid e containment recent sono chiusi dal blocco runtime successivo. I gap P1/P2 catalogo residui restano backlog. `STOREFRONT-AVAILABILITY-PRESENTATION-1A` e integrato; l'ordine operativo e `CATALOG-ASYNC-CART-1A`, `PDP-BRAND-LOGO-1A`, quindi `STOREFRONT-OFFERS-PROMO-VERIFY-1A` soltanto quando i dati promo saranno attivi. `SIDE-CART-OFFCANVAS-ONSUS-AUDIT-1` resta separato.
