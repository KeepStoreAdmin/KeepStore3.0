...
Backlog carrello/ordine: `CART-PROMO-PRICE-REVALIDATION-1A` deve verificare i punti di ricalcolo prezzo prima della conferma ordine, con avviso se una promo cambia/scade tra inserimento nel carrello e conferma finale. L'audit deve partire da inserimento carrello, ricalcolo carrello/checkout e guard immediata prima di `Carrello_Documento`, senza alterare gateway, email, DB/schema/SP o totali in task non dedicati.
