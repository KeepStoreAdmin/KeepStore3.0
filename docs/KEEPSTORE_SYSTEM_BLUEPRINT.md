...
- Prossimo ordine runtime: `HOTFIX-STOREFRONT-PROMO-DEMO-BADGE-1A`, `STOREFRONT-OFFERS-PROMO-ONSUS-AUDIT-1A`, `STOREFRONT-OFFERS-PROMO-UX-1A`, `PDP-BRAND-LOGO-1A`. Finding aperto: `ProductCard.ascx`, dentro `phBadge`, contiene ancora il testo hardcoded `Demo`; non e corretto qui e la gestione promo non e dichiarata completa. Catalogo e PDP restano non completi; AI/Gemini/LLMS resta finale.
