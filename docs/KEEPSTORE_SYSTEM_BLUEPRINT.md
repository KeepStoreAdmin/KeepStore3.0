...
| --- | --- | --- |
| Titolo prodotto | `h5.product-info-name.fw-semibold`: `Inter`, 22px, 600, 25px, `#333e48` | `.ks-product-page .product-info-name` identico; margine responsive come ONSUS |
| Prezzo principale | `.product-info-price h4.text-primary`: `Inter`, 30px, 500, 36px, `#ff3d3d` | `.ks-product-price .new-price` principale 30/500/36 primary |
| Body/descrizione | `.body-text-3`: `Inter`, 14px, 400, 20px, `#333e48` | descrizioni e valori testuali prodotto 14/400/20 |
| Metadati/feature label | `.body-md-2.fw-semibold`: `Inter`, 14px, 600, 22px, `#333e48` | label feature 14/600/22 |
| Tab | `.tab-link.product-title.fw-semibold`: `Inter`, 18px, 600, 24px, active `#004ec3` | tab prodotto 18/600/24 anche su mobile |
| Nome card prodotto | `.name-product.body-md-2.fw-semibold.text-secondary.link`: 14px, 600, 22px, `#004ec3` | card name 14/600/22 secondary/link |
| Prezzo card | `.new-price.price-text.fw-medium`: 20px, 500, 22px, `#333e48` | card price 20/500/22 text |
| CTA | `.tf-btn`: 15px, 600, 24px, padding 10px 16px, height 44px | CTA prodotto/card 15/600/24, padding 10x16 |
