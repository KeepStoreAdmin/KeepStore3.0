...
Backlog successivo non immediato: estensione `DispoTipo` e promo/offerte a catalogo/product card, poi Home e carrello con micro-task dedicati; eventuale polish grafico generale resta separato dalla chiusura scheda articolo.
