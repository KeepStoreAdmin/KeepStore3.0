...
| 2026-06-25 | ARTICLE-AVAILABILITY-PROMO-LEGACY-1B | #198 | REV3 | `App_Code/AvailabilityDisplayHelper.vb`, `App_Code/ProductPromotionDisplayHelper.vb`, `articolo.aspx.vb`, `product-ui.css`, documentazione | Tooltip `In Arrivo`, validita date promo, filtro `AziendeId`/listino, contesto dominio/listino/DispoTipo riallineato su scheda articolo e fallback promo da riga `vsuperarticoli` corrente | Completa solo la scheda articolo `id=12384`; disponibilita numerica letta dal DB live, Webaffare su listino 10/IVA inclusa, nessuna estensione a home/catalogo/carrello/ordine | PR #198 aggiornata; nessun cambio a DB/schema/SP, gateway, email/auth, carrello, `cart_add.aspx`, `ordine.aspx`, home o catalogo |
