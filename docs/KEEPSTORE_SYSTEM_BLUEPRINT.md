...
Esempio vincolante: `articoli.aspx` ha molti micro-task chiusi su ricerca, zero-results, sidebar, filtri applicati, card prodotto, selezione multipla, quantita gia nel carrello, delta quantita, visual mobile della quantita e CTA `Acquista`. Questo non rende la pagina catalogo completa ne "allineata ONSUS" in senso pieno. Restano da auditare e implementare full ONSUS parity, funzioni residue, controlli, sort, layout, componenti commerciali e comportamento responsive complessivo con task dedicati.
