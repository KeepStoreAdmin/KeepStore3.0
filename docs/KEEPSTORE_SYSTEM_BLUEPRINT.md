...
Chiusura PR #198: merge commit `eaf2618a7a243a43fc733f906061f28a52a559cc` su `frontend-rebuild`; PR #196, PR #197 e PR #198 sono chiuse/mergeate. La scheda articolo `articolo.aspx?id=12384` e la variante `articolo.aspx?id=12384&TCid=-1`, anche con Host simulato `www.webaffare.it`, sono il riferimento per layout ONSUS, `Aziende.DispoTipo`, disponibilita legacy numerica, promo/offerte/listino e tooltip `In Arrivo`. Regola campo: usare sempre `DispoTipo`, mai `DispTipo`; `1` = sintetico/pallini, `2` = numerico. Con `DispoTipo=2` il comportamento validato e `Disponibilita: 9`, `Impegnati: 3`, `In Arrivo: 2`, stato `Disponibile` verde; il valore `9` dipende dal DB live corrente. Tooltip `In Arrivo`: riga compatta, icona info CSS scoped senza asset immagine, testo lungo non fisso e fallback `title`/`aria-label`/`data-tooltip`. Promo Webaffare: listino 10, prezzi IVA inclusa, prezzo listino `40,00`, prezzo standard `40,00`/`36,00`, prezzo finale `9,76`, sconto `76%`, `MULTIPLI 10`, `MINIMO 1`, `MULTIPLI 5`, date `25/06/2026-31/07/2026`, promo scadute escluse. In multi-azienda le offerte devono restare filtrate per `AziendeId`, listino e data: nessuna promo puo attraversare aziende/listini nello stesso DB. Home, catalogo, product card, carrello, `cart_add.aspx`, ordine, DB/schema/SP, gateway, email e auth restano fuori scope PR #198; `Public/assets/images/articoli/` non tracciata resta esclusa.
