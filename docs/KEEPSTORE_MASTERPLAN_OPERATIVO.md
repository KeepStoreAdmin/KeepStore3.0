...
Stato Git stabile dopo la chiusura HOME CTA:

- `frontend-rebuild` e `origin/frontend-rebuild`: `4d41734ef317c98a101e5ebc6aa73e9ca3c3bf3e`.
...
- Catalogo `articoli.aspx`: chiusi multiselect, quantita gia in carrello su catalogo, delta quantita, fix visual mobile della quantita in carrello, CTA `Acquista` catalogo, zero-results assistito, sidebar filtri/Settori/applied filters e performance zero-results. Non dichiarare il catalogo completo.
...
1. Priorita 1 - PDP / scheda prodotto `articolo.aspx`.
   - `PDP-BUY-CTA-ACQUISTA-AUDIT-1`: audit read-only CTA acquisto scheda prodotto.
   - `PDP-BUY-CTA-ACQUISTA-1A`: runtime dopo audit, senza toccare catalogo/HOME gia chiusi.
   - `ARTICOLO-CART-QTY-IN-PDP-AUDIT-1`: audit quantita gia in carrello su scheda prodotto.
