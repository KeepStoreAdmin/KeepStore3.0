...
Stato di riferimento corrente dopo chiusura scheda articolo / disponibilita / promo / deduplica buy-box:

- Branch stabile: `frontend-rebuild`
- HEAD stabile: `94c328c16f172b352bc1a5a99915dcc56b766c50`
...
- Backlog successivo non immediato: estendere `DispoTipo` e promo/offerte a catalogo/product card, poi Home e carrello con micro-task separati; eventuale ottimizzazione grafica generale resta futura e non riapre la chiusura PR #198/#199.
