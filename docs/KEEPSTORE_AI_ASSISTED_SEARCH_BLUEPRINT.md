...
Checkpoint corrente 2026-09-03: `frontend-rebuild` / `origin/frontend-rebuild` a `58f4ee43c363d629b3124fc0fb1a10beaeeef48a`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. Le directory non tracciate `Public/assets/images/articoli/`, `Public/assets/images/marche/` e `Public/assets/images/settori/` restano escluse dai commit. Il precedente checkpoint `HOTFIX-CARD-LAYOUT-1A` a `982cc83bcbcbb913dd1e320ece456957801f8121` resta riferimento storico, non stato stabile corrente.
...
- `STOREFRONT-CARD-BUY-CTA-STABILITY-1A` e CHIUSO / A al commit/stable corrente `58f4ee43c363d629b3124fc0fb1a10beaeeef48a`, branch `task/storefront-card-buy-cta-stability-1a`, base `b80f8d4683bbb9bb6ec8a7a486a79048bfae094f`, merge fast-forward e smoke utente A. La CTA `.ks-compact-buy-cta` resta un controllo quadrato stabile `44x44`, con icona, tooltip accessibile, spinner senza salto geometrico e adattamento via container query. I precedenti riferimenti storici alla CTA con testo `Acquista` espandibile su hover/focus sono superati da questo contratto; nessuna logica ecommerce o JavaScript e stata cambiata dal polish di stabilita.
- Prossimo runtime ufficiale `LOGIN-RETURN-CONTEXT-1A`; segue `PDP-BRAND-LOGO-1A`. `STOREFRONT-OFFERS-PROMO-VERIFY-1A` parte solo dopo disponibilita di dati offerte/promozioni reali confermata da Germano. Side cart, parity P1/P2 e blocchi ecommerce restano separati; SEO/AI/Gemini/LLMS rimane priorita finale. Catalogo e PDP non sono dichiarati completi.
...
- `GLOBAL-TYPOGRAPHY-ONSUS-1C` e NON NECESSARIO / NON CREATO e il blocco typography storefront e CHIUSO. Questa chiusura non dichiara complete HOME, catalogo, PDP, header o footer. Audit catalog parity e runtime `1A/1B/1C`, availability, hotfix card-layout, async cart e stabilita CTA sono chiusi; `articoli.aspx` resta esplicitamente non completa. Il prossimo runtime e `LOGIN-RETURN-CONTEXT-1A`, seguito da `PDP-BRAND-LOGO-1A`; side cart resta successivo e Gemini/LLMS resta Priorita 8/finale. Nessuna query, logica search/AI, ranking o runtime AI e stata modificata da questi blocchi o dalla sola riconciliazione docs.
