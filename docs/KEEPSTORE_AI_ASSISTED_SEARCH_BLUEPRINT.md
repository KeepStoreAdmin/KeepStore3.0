...
11. `CATALOG-MULTISELECT-ADD-BUTTON-1A`
   ...
   - restano backlog separati side cart/offcanvas, ritorno `Continua lo shopping`, quantita gia presente nel carrello durante navigazione, funzioni ONSUS mancanti e immagini rotte/path DB.

12. `AI-ASSISTANT-DATA-PROFILE-AUDIT-1A`
