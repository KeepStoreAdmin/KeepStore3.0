...
Checkpoint corrente 2026-09-16: `frontend-rebuild` / `origin/frontend-rebuild` a `9fed039d4563fd20ecc02859236d90e7a2f0be5d`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `ORDER-DURABLE-IDEMPOTENCY-1A` e chiuso A con PR #254 integrata fast-forward. `STOREFRONT-PROMO-MODERN-PARITY-1A` e in review sul branch dedicato; le 46 immagini locali non tracciate restano escluse dai commit e preservate.
...
Roadmap vigente: `STOREFRONT-PROMO-MODERN-PARITY-1A` deve completare review e merge separato; soltanto dopo potra essere candidato `STOREFRONT-PROMO-ROUTE-RETIREMENT-1A`. `CART-IDEMPOTENCY-PERSISTENCE-AUDIT-1A` resta chiuso E e differito; Coupon/Groupon e recesso digitale restano differiti dal Product Owner. SEO tecnico, Google Product structured data e AI/Gemini/LLMS restano finali; feed, JSON-LD, LLMS, Gemini e structured data non sono stati modificati. HOME, catalogo, PDP e promo non sono dichiarati completi.

Guardrail promo per future superfici search/AI: prezzi, badge, condizioni quantitative e owner derivano dalla risoluzione server-side corrente, anche nei `Visti di recente`; localStorage conserva soltanto la cronologia minima e non dati commerciali. Il prezzo principale e il miglior prezzo applicabile alla quantita `1`; un tier futuro e soltanto un teaser separato `Da ...` con condizione e non autorizza search, feed o AI a presentarlo come prezzo immediato, omettere condizioni o stimare prezzi personali. Il retirement legacy resta vietato finche il confronto diretto completo Legacy/Modern non restituisce differenze e duplicati pari a zero.
