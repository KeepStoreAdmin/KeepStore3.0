...
Checkpoint `MULTITENANT-BY-DESIGN`: fondamenta SEO, onboarding, Product structured data e asset runtime sono integrati con PR #261/#262/#263/#264; il checkpoint stabile e `5e01d3e805842c47cabea2f7bee22254701f0110`. `MULTI-STOREFRONT-PRICING-ACCOUNT-ISOLATION-1A` certifica ora account, listini e snapshot commerciali same-database; carrello e ordine restano nei task successivi. Search, AI, feed e structured data devono riusare identita tenant e dati autorevoli, mai inferire il cliente da host grezzi, nomi database, esempi merceologici o dati di un altro tenant.
