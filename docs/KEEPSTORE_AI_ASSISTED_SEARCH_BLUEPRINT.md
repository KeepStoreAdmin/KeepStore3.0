...
Checkpoint corrente 2026-09-17: `frontend-rebuild` / `origin/frontend-rebuild` a `192701ae65ecac00c294399a686af52d98d398c1`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `STOREFRONT-PROMO-MODERN-PARITY-1A` e chiuso A con PR #255 e `STOREFRONT-PROMO-ROUTE-RETIREMENT-1A` e chiuso A con PR #256, entrambe integrate fast-forward. La REV2 tecnica di `STOREFRONT-OFFERS-PROMO-UX-1A` e verificata, ma attende il gate visuale reale sui quattro viewport e non e dichiarata A. Le 46 immagini locali non tracciate restano escluse dai commit e preservate.
