...
Checkpoint corrente 2026-09-18: `frontend-rebuild` / `origin/frontend-rebuild` a `f337de11e4a97588289b865caf7dfdccd5089c1c`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `GOOGLE-PRODUCT-STRUCTURED-DATA-1A` e chiuso A con PR #263. Il task asset runtime corrente non cambia Product/Offer, prezzo, disponibilita, owner o cache; il gate residuo e soltanto visuale e la PR resta DRAFT fino alla conferma Product Owner. Le 46 immagini locali non tracciate restano escluse dai commit e preservate.
