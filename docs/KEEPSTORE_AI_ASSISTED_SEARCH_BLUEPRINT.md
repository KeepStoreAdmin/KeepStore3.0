...
Checkpoint corrente 2026-09-18: `frontend-rebuild` / `origin/frontend-rebuild` a `f337de11e4a97588289b865caf7dfdccd5089c1c`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `GOOGLE-PRODUCT-STRUCTURED-DATA-1A` e chiuso A con PR #263. La REV1 asset runtime certifica anche due storefront sintetici nello stesso database logico: canonical/alias, seller, robots, sitemap e asset restano legati alla medesima identita host-scoped, con host ignoti o duplicati fail-closed. Product/Offer, prezzi e disponibilita non cambiano; il gate residuo e soltanto visuale e la PR #264 resta DRAFT fino alla conferma Product Owner. Le 46 immagini locali non tracciate restano escluse dai commit e preservate.
