...
Checkpoint corrente 2026-09-17: `frontend-rebuild` / `origin/frontend-rebuild` a `b87ad17a5dd346d07f9e53c0697bb562c5cb4a93`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `HOME-ASYNC-CART-1A` e chiuso A con PR #258 integrata e certificazione Product Owner sui quattro viewport; JavaScript, search e AI non sono fonte di verita per owner, quantita, prezzo o idempotenza. `PROMO-DISPLAY-ERROR-STATE-HARDENING-1A` e il task corrente. Le 46 immagini locali non tracciate restano escluse dai commit e preservate.
...
Roadmap vigente: parity, retirement, UX promo e HOME async cart hanno completato il rispettivo perimetro; PR #258 e integrata. L'hardening corrente distingue un errore tecnico promozionale dalla legittima assenza di offerte senza rendere search o AI fonte commerciale. Il candidato successivo `STOREFRONT-PROMO-BULK-PERFORMANCE-1A` misurera eventuali query ripetute/N+1 soltanto dopo chiusura A dell'hardening; stato `NON AVVIATO`. `CART-IDEMPOTENCY-PERSISTENCE-AUDIT-1A` resta chiuso E e differito; Coupon/Groupon e recesso digitale restano differiti dal Product Owner. SEO tecnico, Google Product structured data e AI/Gemini/LLMS restano finali; feed, JSON-LD, LLMS, Gemini e structured data non sono stati modificati. HOME, catalogo, PDP e promo non sono dichiarati completi.
