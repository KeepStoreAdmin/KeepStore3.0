...
Checkpoint corrente 2026-09-09: `frontend-rebuild` / `origin/frontend-rebuild` a `df5436deae0bdc672dbed1c7965941a031bb3d49`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `WORKFLOW-GOVERNANCE-1A` e `CART-BATCH-ATOMICITY-1A` sono chiusi e integrati; PR #242 mergiata fast-forward con due commit runtime e zero merge commit. Le directory non tracciate `Public/assets/images/articoli/`, `Public/assets/images/marche/` e `Public/assets/images/settori/` restano escluse dai commit. Anche eventuali loghi locali non tracciati sotto `Public/assets/images/vettori/` vanno preservati e possono essere aggiunti solo se nominativamente autorizzati da uno specifico manifest.
