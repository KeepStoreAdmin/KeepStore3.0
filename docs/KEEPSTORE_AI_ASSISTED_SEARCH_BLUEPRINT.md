...
- `GLOBAL-TYPOGRAPHY-ONSUS-1C` e NON NECESSARIO / NON CREATO e il blocco typography storefront e CHIUSO. Questa chiusura non dichiara complete HOME, catalogo, PDP, header o footer. Il prossimo runtime generale e `CATALOG-ONSUS-PARITY-AUDIT-1`; `articoli.aspx` resta esplicitamente non completa, il side cart resta successivo e Gemini/LLMS resta Priorita 8/finale. Nessuna query, logica search/AI, ranking o runtime AI e stata modificata dal blocco typography.
