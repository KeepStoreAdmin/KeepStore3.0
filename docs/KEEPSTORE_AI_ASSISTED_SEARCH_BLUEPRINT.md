...
Checkpoint corrente 2026-09-17: `frontend-rebuild` / `origin/frontend-rebuild` a `cab4486d229e8c8e8168e2a68798b0ea6d267c4e`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. `STOREFRONT-OFFERS-PROMO-UX-1A` e chiuso A con PR #257 integrata. `HOME-ASYNC-CART-1A` e il task corrente: riusa il percorso carrello server-side esistente e non rende JavaScript, search o AI fonte di verita per owner, quantita, prezzo o idempotenza. Le 46 immagini locali non tracciate restano escluse dai commit e preservate.
...
Roadmap vigente: parity, retirement e UX promo hanno completato il rispettivo perimetro; PR #257 e integrata. `HOME-ASYNC-CART-1A` e il task corrente e mantiene endpoint, CSRF, idempotenza e fallback nativo come invarianti esterni a search/AI. `CART-IDEMPOTENCY-PERSISTENCE-AUDIT-1A` resta chiuso E e differito; Coupon/Groupon e recesso digitale restano differiti dal Product Owner. SEO tecnico, Google Product structured data e AI/Gemini/LLMS restano finali; feed, JSON-LD, LLMS, Gemini e structured data non sono stati modificati. HOME, catalogo, PDP e promo non sono dichiarati completi.
