...
Stato stabile trasversale dopo `HOTFIX-CARD-LAYOUT-1A`: `frontend-rebuild` / `origin/frontend-rebuild` a `982cc83bcbcbb913dd1e320ece456957801f8121`; `main` / `origin/main` invariati a `976e99f17cabc8a5c6a8715463444edfeaadcd91`. Branch runtime `task/storefront-card-layout-regression-1a`, base `ab86e01220ac219fdb82c41ab240d96994d83550`, merge fast-forward only e smoke Germano A. Le directory non tracciate `Public/assets/images/articoli/`, `Public/assets/images/marche/` e `Public/assets/images/settori/` restano escluse dai commit. Gli SHA dei blocchi precedenti restano riferimenti storici corretti.
...
- Prossimo runtime ufficiale `CATALOG-ASYNC-CART-1A`; seguono `PDP-BRAND-LOGO-1A` e `STOREFRONT-OFFERS-PROMO-VERIFY-1A` soltanto dopo attivazione offerte/promozioni da parte di Germano. Side cart, parity P1/P2 e blocchi ecommerce restano separati; SEO/AI/Gemini rimane finale.
...
- `GLOBAL-TYPOGRAPHY-ONSUS-1C` e NON NECESSARIO / NON CREATO e il blocco typography storefront e CHIUSO. Questa chiusura non dichiara complete HOME, catalogo, PDP, header o footer. Audit catalog parity e runtime `1A/1B/1C`, availability e il successivo hotfix card-layout sono chiusi; `articoli.aspx` resta esplicitamente non completa. Il prossimo runtime e `CATALOG-ASYNC-CART-1A`, side cart resta successivo e Gemini/LLMS resta Priorita 8/finale. Nessuna query, logica search/AI, ranking o runtime AI e stata modificata da questi blocchi o dalla sola riconciliazione docs.
