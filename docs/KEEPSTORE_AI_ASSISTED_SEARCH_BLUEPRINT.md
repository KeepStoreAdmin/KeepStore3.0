...
Guardrail promo per future superfici search/AI: prezzi, badge, condizioni quantitative e owner derivano dalla risoluzione server-side corrente, anche nei `Visti di recente`; localStorage puo ordinare la cronologia ma non e fonte di verita commerciale e non deve sovrascrivere card server-side live. La miglior offerta visuale non autorizza search, feed o AI a omettere le altre condizioni ne a stimare prezzi personali.
