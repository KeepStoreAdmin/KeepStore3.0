        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 col-12">
                    <div class="header-bt-left active-container ks-header-bottom-catalog">
                        <div class="nav-category-wrap ks-header-category-wrap">
                            <div class="nav-title btn-active">
                                <i class="icon-menu-dots fs-20"></i>
                                <h6 class="title fw-semibold" data-ks-i18n="nav.departments">Tutte le categorie</h6>
                            </div>
                            <nav class="category-menu active-item" aria-label="Catalogo completo">
                                <div class="menu-category-menu-container">
                                    <div class="tf-nav-menu ks-header-nav-menu">
                                        <ul id="ksDesktopCategoryMenu" class="megamenu menu-category-list ks-header-category-menu">
