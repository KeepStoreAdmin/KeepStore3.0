...
Partial Class SiteHeader
    ...
    Private Function BuildDesktopCatalogMegaMenuHtml(ByVal sectors As List(Of CatalogMenuSector)) As String
        If sectors Is Nothing OrElse sectors.Count = 0 Then
            Return "<li class='menu-item ks-desktop-sector-item ks-no-submenu'><a href='articoli.aspx' class='item-link'><span><span class='ks-desktop-sector-media is-empty'></span><span class='ks-desktop-sector-label'>Catalogo non disponibile</span></span></a></li>"
        End If
        ...
        For Each sector As CatalogMenuSector In sectors
            ...
            Dim hasCategories As Boolean = sector.Categories IsNot Nothing AndAlso sector.Categories.Count > 0

            sb.Append("<li class='menu-item ks-desktop-sector-item")
            If Not hasCategories Then
                sb.Append(" ks-no-submenu")
            End If
            ...
            sb.Append("' class='item-link'>")
            sb.Append("<span>")
            sb.Append("<span class='ks-desktop-sector-media")
            ...
            End If
            sb.Append("</span>")
            sb.Append("<span class='ks-desktop-sector-label'>")
            sb.Append(HttpUtility.HtmlEncode(If(sector.Descrizione, String.Empty)))
            sb.Append("</span>")
            sb.Append("</a>")

            If hasCategories Then
                sb.Append("<div class='sub-menu-container mega-menu text-nowrap ks-desktop-sector-panel'>")
                sb.Append("<div class='wrapper-sub-menu ks-desktop-sector-panel-inner'>")
                For Each category As CatalogMenuCategory In sector.Categories
                    If category Is Nothing Then
                        Continue For
                    End If

                    sb.Append("<div class='mega-menu-item ks-desktop-category-column'>")
                    sb.Append("<a href='")
                    sb.Append(HttpUtility.HtmlAttributeEncode(category.DefaultUrl))
                    sb.Append("' class='menu-heading body-small ks-desktop-category-heading'>")
                    sb.Append(HttpUtility.HtmlEncode(If(category.Descrizione, String.Empty)))
                    sb.Append("</a>")
                    sb.Append("<ul class='menu-list ks-desktop-tipology-list'>")
                    If category.Children IsNot Nothing AndAlso category.Children.Count > 0 Then
                        For Each tipologia As CatalogMenuNode In category.Children
                            ...
                            sb.Append("<li class='ks-desktop-tipology-item'>")
                            sb.Append("<a href='")
                            sb.Append(HttpUtility.HtmlAttributeEncode(tipologia.DefaultUrl))
                            sb.Append("' class='body-md-2 link ks-desktop-tipology-link'><span>")
                    ...
                    Else
                        ...
                        sb.Append("<a href='")
                        sb.Append(HttpUtility.HtmlAttributeEncode(category.DefaultUrl))
                        sb.Append("' class='body-md-2 link ks-desktop-tipology-link'><span>Vedi la categoria</span></a>")
                        sb.Append("</li>")
                    End If
                    sb.Append("</ul>")
                    sb.Append("</div>")
