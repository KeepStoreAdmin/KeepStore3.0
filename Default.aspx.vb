...
Partial Public Class _Default
    ...
    Private Function RenderActionButtons(ByVal row As DataRow, ByVal compact As Boolean) As String
        ...
        sb.Append("<li><a href='").Append(CartAddUrl(row)).Append("' class='box-icon add-to-cart btn-icon-action ks-home-buy-cta ").Append(tooltipClass).Append(" js-ks-cart-link'").Append(quickViewAttrs).Append(" aria-label='Acquista: aggiungi al carrello' title='Acquista: aggiungi al carrello'><i class='icon icon-cart2' aria-hidden='true'></i><span class='ks-home-buy-cta__text'>Acquista</span><span class='tooltip'>Acquista</span></a></li>")
