...
Partial Class Articoli
    ...
    If (Not IsPostBack) AndAlso String.Equals(Request.HttpMethod, "GET", StringComparison.OrdinalIgnoreCase) AndAlso (Session("q") IsNot Nothing) Then
        Dim strCercaQS As String = Convert.ToString(Session("q"))
        ' hardening: no CR/LF, no tab, max len
        strCercaQS = System.Text.RegularExpressions.Regex.Replace(strCercaQS, "[\r\n\t]+", " ")
        If strCercaQS.Length > 250 Then strCercaQS = strCercaQS.Substring(0, 250)
    ...
    If jsonLd Is Nothing Then jsonLd = ""
    ' Prevent </script> break-out in HTML context
