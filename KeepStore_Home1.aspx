<%@ Page Title="Home 1" Language="VB" MasterPageFile="~/Page.master" AutoEventWireup="false" %>
...
<!-- /Header -->
                ...
                <div class="s-banner-wrapper">
                                                    ...
                                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g mask="url(#mask0_1739_24870)">
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="black" stroke-miterlimit="10" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path d="M9.0448 16.6132V17.3433" stroke="black" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M2.6283 10.9551H3.35837" stroke="black" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M4.50122 15.3274L5.01747 14.8111" stroke="black" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M13.1156 14.8111L13.6318 15.3274" stroke="black" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M5.16481 6.86035L4.64856 6.3441" stroke="black" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </g>
                                                    </svg>
                                                </span>
                    ...
                    <div class="wrap-item-2">
                        <div class="banner-image-product-4 style-2 hover-img has-bg-img"
                            style="background-image: url('images/banner/banner-30.jpg');">
                            <div class="content">
                                <div class="box-title">
        ...
        <div class="tf-sp-2 pt-0">
            <div class="container">
                <div class="swiper tf-sw-iconbox" data-preview="5" data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="20"
                    data-space-md="20" data-space="15">
        ...
        <section class="tf-sp-2 pt-0">
            <div class="container">
                ...
                <div class="box-btn-slide-2 sw-nav-effect">
                    <div class="swiper tf-sw-products slider-thumb-deal" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="1"
                        data-space-lg="30" data-space-md="20" data-space="15" data-pagination="1" data-pagination-sm="2" data-pagination-md="3"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <div class="box-infor-detail gap-xl-20">
                                            <div class="countdown-box">
                                                <div class="js-countdown" data-timer="102738" data-labels="Days,Hours,Mins,Secs">
                                                </div>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product style-border  wow fadeInLeft" data-wow-delay="0.1s">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <div class="box-infor-detail gap-xl-20">
                                            <div class="countdown-box">
                                                <div class="js-countdown" data-timer="22671" data-labels="Days,Hours,Mins,Secs">
                                                </div>
                                            </div>
                                            <div class="product-progress-sale">
                                                <div class="progress-sold progress" role="progressbar" aria-valuemin="0" aria-valuemax="100">
                            ...
                            <div class="swiper-slide">
                                <div class="card-product style-border wow fadeInLeft" data-wow-delay="0.2s">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <div class="box-infor-detail gap-xl-20">
                                            <div class="countdown-box">
                                                <div class="js-countdown" data-timer="5804" data-labels="Days,Hours,Mins,Secs">
                                                </div>
                                            </div>
                                            <div class="product-progress-sale">
                                                <div class="progress-sold progress" role="progressbar" aria-valuemin="0" aria-valuemax="100">
                            ...
                            <div class="swiper-slide">
                                <div class="card-product style-border wow fadeInLeft" data-wow-delay="0.3s">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <div class="box-infor-detail gap-xl-20">
                                            <div class="countdown-box">
                                                <div class="js-countdown" data-timer="8738" data-labels="Days,Hours,Mins,Secs">
                                                </div>
                                            </div>
                                            <div class="product-progress-sale">
                                                <div class="progress-sold progress" role="progressbar" aria-valuemin="0" aria-valuemax="100">
                                                ...
                                                <div class="box-title">
                                                    ...
                                                    <div class="group-btn">
                                                        ...
                                                        <ul class="list-product-btn flex-row">
                                                            ...
                                                            <li class="wishlist">
                                                                <a href="#;" class="box-icon btn-icon-action hover-tooltip">
                                                                    <i class="icon icon-heart2"></i>
                                                                    <span class="tooltip">Add to Wishlist</span>
                                                                </a>
                                                            </li>
        ...
        <div class="themesFlat">
            <div class="container">
                <div class=" swiper tf-sw-categories" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="30"
        ...
        <section class="tf-sp-2">
            <div class="container">
                ...
                <div class="swiper tf-sw-products" data-preview="5" data-tablet="4" data-mobile-sm="3" data-mobile="2" data-space-lg="30"
                    data-space-md="15" data-space="15" data-pagination="2" data-pagination-sm="3" data-pagination-md="4" data-pagination-lg="5"
                    data-grid="2">
                    <div class="swiper-wrapper">
                        <!-- item 1 -->
                        <div class="swiper-slide">
                                ...
                                <div class="card-product-wrapper">
                                    ...
                                    <ul class="list-product-btn">
                                        ...
                                        <li class="d-none d-sm-block">
                                            <a href="#compare" data-bs-toggle="offcanvas" class="box-icon btn-icon-action hover-tooltip tooltip-left">
                                                <i class="icon icon-compare1"></i>
                                                <span class="tooltip">Compare</span>
                                            </a>
                                        </li>
            ...
            <div class="container">
                <div class="tf-grid-product">
                    <div class="tf-grid-product-item box-btn-slide-item">
                        ...
                        <div class="swiper tf-sw-products" data-preview="1" data-tablet="1" data-mobile-sm="1" data-mobile="1" data-space-lg="20"
                            data-space-md="20" data-space="20" data-pagination="1" data-pagination-sm="1" data-pagination-md="1"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$71.999</span>
                                                                <span class="old-price body-md-2 text-main-2">$89.999</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$61.200</span>
                                                                <span class="old-price body-md-2 text-main-2">$76.500</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$75.990</span>
                                                                <span class="old-price body-md-2 text-main-2">$94.990</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$66.200</span>
                                                                <span class="old-price body-md-2 text-main-2">$82.750</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$79.900</span>
                                                                <span class="old-price body-md-2 text-main-2">$99.900</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$38.500</span>
                                                                <span class="old-price body-md-2 text-main-2">$45.990</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$74.250</span>
                                                                <span class="old-price body-md-2 text-main-2">$92.750</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$62.999</span>
                                                                <span class="old-price body-md-2 text-main-2">$78.490</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$12.499</span>
                                                                <span class="old-price body-md-2 text-main-2">$15.999</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$47.900</span>
                                                                <span class="old-price body-md-2 text-main-2">$59.800</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$71.500</span>
                                                                <span class="old-price body-md-2 text-main-2">$89.990</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                            ...
                                            <div class="card-product style-row row-small-2 ">
                                                ...
                                                <div class="card-product-info">
                                                    <div class="box-title">
                                                        ...
                                                        <div class="group-btn">
                                                            <p class="price-wrap fw-medium">
                                                                <span class="new-price price-text fw-medium">$15.499</span>
                                                                <span class="old-price body-md-2 text-main-2">$19.999</span>
                                                            </p>
                                                            <ul class="list-product-btn flex-row">
                                                                <li>
                                                                    <a href="#shoppingCart" data-bs-toggle="offcanvas"
        ...
        <section>
            <div class="container">
                <div class=" swiper tf-sw-categories overflow-xxl-visible" data-preview="2" data-tablet="2" data-mobile-sm="1" data-mobile="1"
                    data-space-lg="30" data-space-md="20" data-space="15" data-pagination="1" data-pagination-sm="2" data-pagination-md="2"
