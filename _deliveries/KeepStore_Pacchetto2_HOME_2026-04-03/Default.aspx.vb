...
Partial Public Class _Default
    ...
    Private Function GetNewArrivalsPool(ByVal limit As Integer) As DataTable
        Return QueryProducts(StockWhereClause() & ">=1 AND COALESCE(v.DataCreazione,'1900-01-01') > '1900-01-01'",
                             "COALESCE(v.DataCreazione,CURDATE()) DESC, COALESCE(v.Visite,0) DESC, v.id DESC",
                             limit)
    End Function
    ...
    Private Function TryLoadProducts(ByVal whereClause As String, ByVal orderClause As String, ByVal limit As Integer) As DataTable
        ...
        sql.Append("COALESCE(v.Abilitato,1) AS Abilitato, ")
        ...
        sql.Append("COALESCE(v.Stato,0) AS Stato, COALESCE(v.Ricondizionato,0) AS Ricondizionato, ")
        ...
        sql.Append("AND COALESCE(v.Abilitato,1)=1 ")
