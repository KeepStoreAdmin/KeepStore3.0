...
Partial Public Class UI_HomeDepartmentsMenu
    ...
    Private Function BuildDesktopSubMenuHtml(ByVal sector As CatalogMenuSector) As String
        ...
        For Each category As CatalogMenuCategory In sector.Categories
            ...
            sb.Append("' class='ks-home-submenu-category link'>")
            ...
            If category.Children IsNot Nothing AndAlso category.Children.Count > 0 Then
                sb.Append("<div class='ks-home-submenu-tier'>")
                sb.Append("<span class='ks-home-submenu-tier-title'>Tipologie</span>")
                sb.Append("<ul class='ks-home-submenu-tipology-list'>")
                ...
                For Each tipologia As CatalogMenuNode In category.Children
                    ...
                    If tipologia.Children IsNot Nothing AndAlso tipologia.Children.Count > 0 Then
                        sb.Append("<div class='ks-home-submenu-tier ks-home-submenu-tier-groups'>")
                        sb.Append("<span class='ks-home-submenu-tier-title'>Gruppi</span>")
                        sb.Append("<ul class='ks-home-submenu-group-list'>")
                        For Each groupNode As CatalogMenuNode In tipologia.Children
                            ...
                            sb.Append("' class='ks-home-submenu-group-link'>")
                            sb.Append(HttpUtility.HtmlEncode(groupNode.Descrizione))
                            sb.Append("</a></li>")
                        Next
                        sb.Append("</ul>")
                        sb.Append("</div>")
