...
Public Module CatalogMenuProvider
    ...
    Public Function ResolveSectorImageUrl(ByVal imgValue As Object) As String
        ...
        Dim virtualPath As String = "/Public/assets/images/settori/" & fileName
        Try
            Dim absolutePath As String = HostingEnvironment.MapPath("~" & virtualPath)
            If Not String.IsNullOrWhiteSpace(absolutePath) AndAlso File.Exists(absolutePath) Then
                Return virtualPath
            End If
        Catch
        End Try
