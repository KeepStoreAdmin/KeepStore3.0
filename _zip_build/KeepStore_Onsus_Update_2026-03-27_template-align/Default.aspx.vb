...
Partial Public Class _Default
    ...
    Protected Function ResolveHeroSlideImage(ByVal value As Object, ByVal fallback As String) As String
        Return ResolveProjectImage(value, fallback, "/Images/Slide_Show/", "/Public/assets/images/slideshows/", "/Public/assets/images/banner/")
    End Function

    Protected Function ResolveAdvertisingImage(ByVal value As Object, ByVal fallback As String) As String
        Return ResolveProjectImage(value, fallback, "/Public/Banner/", "/Public/assets/images/banner/")
    End Function
